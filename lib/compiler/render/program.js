 ...
 * @type {Set<string>}
 */
export const RANGE_OPS = new Set([OpKind.IF, OpKind.FOR, OpKind.SLOT]);
...
export const FallbackReason = {
  ...
  // LIST, COMPONENT and SLOT are retained because the legacy compileTemplate
  // entry point still reports them while it exists. The IR path lowers all
  // three, and its own reasons live in lib/compiler/ir/nodes.js.
