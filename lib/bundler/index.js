...
import { buildGraph, BindingError } from './graph.js';
import { emitBundle, EmitError } from './emit.js';
import { ModuleParseError } from './parseModule.js';

export { Resolver, ResolveError, BindingError, EmitError, ModuleParseError, isRuntimeSpecifier, AVENX_PACKAGE_ROOT };
...
export function bundle({
  ...
  // Everything in the graph is reachable from an entry by construction, so this
  // is the whole bundle until export-level shaking narrows it further.
