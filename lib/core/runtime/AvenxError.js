...
export const AvenxErrorMessages = {
  ...
  [AvenxErrorCodes.ATLAS_UNREAD_STATE]:
    '{0} is {1} read nowhere in the application ({2}).\nAtlas found no template binding, computed, action, resource or guard that reads it. Delete it, or check whether the read it was meant to have is missing. Run "avenx impact {0}" to see the relationships Atlas did find.',
